...
Minimalist, brutalist styling for the Flask dashboards.

The visual language every dashboard in this project shares: brutalist, monospaced, high-contrast, no decoration. Documented so a new dashboard matches the existing ones.
...
border-width: 0.85px;
```
**Always use 0.85px** - the signature thin border of this system
...
Following this keeps every dashboard in the project visually consistent.
