"""
Configuration management for follower signal system.
"""
...
class FollowerConfig:
    """
    Central configuration for the follower signal system.
    ...
    def __init__(self, config_path: str = None):
        ...
        Args:
            config_path: Path to config.json (defaults to ./follower/config.json)
        """
    ...
    @property
    def good_trader_score_threshold(self) -> int:
        """Score threshold for identifying good traders (default: 90)."""
        return self._config.get("good_trader_score_threshold", 90)
    ...
    def __repr__(self) -> str:
        return f"FollowerConfig(path={self.config_path})"
