"""
Web-based dashboard for follower signals using Flask.

Provides a real-time web interface showing good trader positioning and follower signals.
"""
...
class WebDashboard:
    """
    Web-based dashboard for follower signals.
    ...
    def _setup_routes(self):
        ...
        def get_signals():
            ...
            return jsonify({
                ...
                'stats': {
                    'good_traders_count': self.good_traders_count,
